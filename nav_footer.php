...
$navItems = [
    ...
    ['label' => 'บัญชี',       'icon' => '<path d="M20 21v-2a4 4 0 0 0-4-4H8a4 4 0 0 0-4 4v2"/><circle cx="12" cy="7" r="4"/>', 'url' => 'accounts.php'],
    ['label' => 'ข้อความ',     'icon' => '<path d="M21 11.5a8.4 8.4 0 0 1-.9 3.8 8.5 8.5 0 0 1-7.6 4.7 8.4 8.4 0 0 1-3.8-.9L3 21l1.9-5.7a8.4 8.4 0 0 1-.9-3.8 8.5 8.5 0 0 1 4.7-7.6 8.4 8.4 0 0 1 3.8-.9h.5a8.48 8.48 0 0 1 8 8v.5z"/>'],
...
<div class="navbar">
  ...
  <div class="navitem<?= $isActive ? ' active' : '' ?>" onclick="<?= $onclick ?>" data-label="<?= htmlspecialchars($nav['label']) ?>">
    <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.9" stroke-linecap="round" stroke-linejoin="round"><?= $nav['icon'] ?></svg>
